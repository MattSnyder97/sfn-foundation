                ...
                <tr>
                  <td style="padding:0 32px 32px 32px;">
                    ...
                    <div style="text-align:center; margin-top:32px;">
                      <a href="https://sfn-foundation.org" style="display:inline-block; border-radius:16px; border:2px solid #5159CF; background:#5159CF; color:#FBF8F8; font-weight:600; font-family:Lato,sans-serif; padding:16px 12px; text-decoration:none; font-size:16px;">Approve Sign In</a>
                    </div>
                  </td>
                </tr>
              </table>
