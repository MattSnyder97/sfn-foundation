  ...
  sections: [
    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Supplements can be an important part of managing Small Fiber Neuropathy, 
        ...
        {
          type: "paragraph",
          text: `Many people with SFN have nutrient deficiencies that can make their 
        ...
        {
          type: "paragraph",
          text: `Always talk to your doctor before starting any new supplements, 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Some supplements have strong scientific research showing they can help 
        ...
        {
          type: "paragraph",
          text: `Alpha-lipoic acid is one of the most studied supplements for neuropathy. 
        ...
        {
          type: "paragraph",
          text: `These supplements work slowly, so you need to be patient. It often takes 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Certain vitamins are crucial for healthy nerve function. Many people 
        ...
        {
          type: "paragraph",
          text: `B vitamins are especially important for nerve health. Your nerves need 
        ...
        {
          type: "paragraph",
          text: `It's important to get your vitamin levels checked with blood tests before 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Antioxidants help protect your nerves from damage caused by free radicals 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Certain minerals are essential for proper nerve function and pain 
        ...
        {
          type: "paragraph",
          text: `Be careful with mineral supplements because it's possible to take too 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Not all supplements are created equal. The supplement industry is not 
        ...
        {
          type: "paragraph",
          text: `Look for supplements that have been tested by independent third parties 
        ...
        {
          type: "paragraph",
          text: `Some supplements can cause side effects or interact with medications. 
        ...
        {
          type: "paragraph",
          text: `Keep a journal of which supplements you take and how you feel. This 
        ...
        {
          type: "paragraph",
          text: `Be patient with supplements. Unlike prescription medications that often 
