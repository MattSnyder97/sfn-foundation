  ...
  sections: [
...

    {
      ...
      content: [
        ...
        {
          type: "paragraph",
          text: `Common acronyms you may see include ALA (alpha-lipoic acid, a supplement), ALCAR (acetyl-L-carnitine), EMG (electromyography), IENFD (intraepidermal nerve fiber density from a skin biopsy), iSFN (idiopathic SFN), IVIG (intravenous immunoglobulin), JAKi (Janus kinase inhibitors), LDN (low dose naltrexone), MCAS (mast cell activation syndrome), NCS (nerve conduction study), QSART (sudomotor testing), SFN (small fiber neuropathy), and TST (thermoregulatory sweat test). If a term is unclear, ask your provider for a plain-language explanation.`,
        },
      ],
    },

    {
      ...
      content: [
        ...
        {
          type: "paragraph",
          text: `Medical terms you may read include allodynia (pain from light touch), autonomic neuropathy (damage to nerves controlling automatic functions), axon (part of a nerve cell), distal (far from the body center), hyperalgesia (increased pain sensitivity), hypesthesia (reduced feeling), idiopathic (no known cause), inflammation (immune response), myelin (protective nerve coating), neuropathic pain (pain from nerve problems), paresthesia (tingling), peripheral nervous system (nerves outside brain/spinal cord), polyneuropathy (many nerves affected), and proximal (closer to the body center). Ask your provider if a term is confusing.`,
        },
      ],
    },
