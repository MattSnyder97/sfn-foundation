  ...
  sections: [
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `These are the most frequently used abbreviations and acronyms in 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `These medical terms are commonly used when discussing Small Fiber 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Understanding the tests and procedures used to diagnose Small Fiber 
