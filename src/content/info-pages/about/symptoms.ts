export const symptomsContent = {
  ...
  sections: [
    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Small Fiber Neuropathy affects the smallest nerves in your body. These 
        ...
        {
          type: "paragraph",
          text: `The symptoms of SFN can be different for each person. Some people have 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `SFN symptoms can change as time goes on. For some people, symptoms stay 
        ...
        {
          type: "paragraph",
          text: `The progression of SFN depends on what's causing it. If you have diabetes 
        ...
        {
          type: "paragraph",
          text: `Not everyone follows this pattern. Some people have symptoms that stay 
...

    {
      ...
      content: [
        {
          type: "paragraph",
          text: `Living with SFN symptoms can affect many parts of your daily life. 
        ...
        {
          type: "image",
          src: "/images/common/insomniaWoman.png",
          alt: "Person sitting on bed at night, depicting sleep difficulties from neuropathy pain",
          caption:
  ...
  meta: {
    ...
    references: [
      ...
      {
        title:
          "Small fiber neuropathy - National Institute of Neurological Disorders",
